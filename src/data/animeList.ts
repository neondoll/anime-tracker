...
export const animeList: Omit<Anime, "id">[] = [
  ...
  },
  {
    ...
    description: "Дочь бога и демонессы помогает духам почувствовать себя людьми. Фэнтези о приключениях между небом и землей",
    video: "https://www.kinopoisk.ru/series/5264177/",
  },
  {
  ...
  },
  {
    ...
    description: "Потомственный демон вынужден служить юной чародейке. Остроумное аниме режиссёра «Тёмного собрания»",
  ...
  },
  {
    ...
    episodes: 13,
    progress: {
      owl: { watchedEpisodes: 5, status: "dropped" },
      crocodile: { watchedEpisodes: 5, status: "dropped" },
    },
  ...
  },
  {
    ...
    description: "Избалованный император случайно меняется телами с нелюбимой женой. Остроумное фэнтези из Китая",
  ...
  },
  {
    ...
    genres: ["Фэнтези", "Боевик", "Комедия"],
    description: "Вождь должен справиться со странным недугом и защитить племя. Фэнтези с юмором и магическими ритуалами",
  ...
  },
  {
    ...
    description: "Магическая кисть помогает студенту связаться с потусторонним миром. Боевик, вдохновленный китайской мифологией",
  ...
  },
  {
    ...
    episodes: 18,
    progress: {
      owl: { watchedEpisodes: 18, status: "completed" },
      crocodile: { watchedEpisodes: 0, status: "not_interested" },
    },
    genres: ["Боевик", "Фэнтези"],
    description: "Разлученные в детстве братья сходятся в смертельной схватке. Зрелищное фэнтези о мастерах боевых искусств",
  ...
  },
  {
    ...
    description: "Современная карьеристка попадает в средневековый Китай. Историческое аниме про любовь и приключения",
  ...
  },
  {
    ...
    genres: ["Фэнтези", "Боевик"],
    description: "Чтобы спасти мир, люди объединяются против монстров из небытия. Смесь экшена и сай-фая с ноткой романтики",
